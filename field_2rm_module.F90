...
CONTAINS
  ...
  PROCEDURE :: DELETE_DEVICE => FIELD_2RM_DELETE_DEVICE
  ...
  PROCEDURE, PRIVATE :: GET_DEVICE_DATA => FIELD_2RM_GET_DEVICE_DATA
  PROCEDURE, PRIVATE :: GET_HOST_DATA => FIELD_2RM_GET_HOST_DATA
  PROCEDURE, PRIVATE :: FIELD_2RM_GET_HOST_DATA
  PROCEDURE, PRIVATE :: COPY_DATA =>  FIELD_2RM_COPY_DATA
  PROCEDURE, PRIVATE :: CREATE_DEVICE_DATA => FIELD_2RM_CREATE_DEVICE_DATA
END TYPE FIELD_2RM
...
CONTAINS
  ...
  PROCEDURE, PRIVATE :: ALLOCATE => FIELD_2RM_ALLOCATE
  PROCEDURE, PRIVATE :: GET_HOST_DATA => FIELD_2RM_OWNER_GET_HOST_DATA
...
CONTAINS
  ...
  SUBROUTINE FIELD_2RM_WRAP(SELF, DATA, PERSISTENT, LBOUNDS)
    
    CLASS(FIELD_2RM_WRAPPER), INTENT(INOUT) :: SELF
  ...
  END SUBROUTINE FIELD_2RM_WRAP

  SUBROUTINE FIELD_2RM_OWNER_INIT (SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED)
  ...
  SUBROUTINE FIELD_2RM_ALLOCATE (SELF)
    
    CLASS(FIELD_2RM_OWNER) :: SELF

    
    
  END SUBROUTINE FIELD_2RM_ALLOCATE
  ...
  SUBROUTINE FIELD_2RM_DELETE_DEVICE(SELF)
    
    CLASS(FIELD_2RM) :: SELF

    
  END SUBROUTINE FIELD_2RM_DELETE_DEVICE
  ...
  SUBROUTINE FIELD_2RM_GET_HOST_DATA (SELF, MODE, PTR, QUEUE)
    CLASS(FIELD_2RM),                INTENT(INOUT) :: SELF
  ...
  SUBROUTINE FIELD_2RM_OWNER_GET_HOST_DATA (SELF, MODE, PTR, QUEUE)
    CLASS(FIELD_2RM_OWNER),          INTENT(INOUT) :: SELF
    INTEGER (KIND=JPIM),           INTENT(IN)    :: MODE
    REAL(KIND=JPRM), POINTER,          INTENT(INOUT) :: PTR(:,:)
    INTEGER (KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
  ...
  INTEGER (KIND=JPIM) FUNCTION FIELD_2RM_GET_LAST_CONTIGUOUS_DIMENSION (PTR) RESULT (JDIM)
  REAL(KIND=JPRM), POINTER :: PTR (:,:)
  INTEGER*8 :: ISTRIDE (2)
