...
CONTAINS
  ...
  PROCEDURE :: DELETE_DEVICE => FIELD_2LM_DELETE_DEVICE
  ...
  PROCEDURE, PRIVATE :: GET_DEVICE_DATA => FIELD_2LM_GET_DEVICE_DATA
  PROCEDURE, PRIVATE :: GET_HOST_DATA => FIELD_2LM_GET_HOST_DATA
  PROCEDURE, PRIVATE :: FIELD_2LM_GET_HOST_DATA
  PROCEDURE, PRIVATE :: COPY_DATA =>  FIELD_2LM_COPY_DATA
  PROCEDURE, PRIVATE :: CREATE_DEVICE_DATA => FIELD_2LM_CREATE_DEVICE_DATA
END TYPE FIELD_2LM
...
CONTAINS
  ...
  PROCEDURE, PRIVATE :: ALLOCATE => FIELD_2LM_ALLOCATE
  PROCEDURE, PRIVATE :: GET_HOST_DATA => FIELD_2LM_OWNER_GET_HOST_DATA
...
CONTAINS
  ...
  SUBROUTINE FIELD_2LM_WRAP(SELF, DATA, PERSISTENT, LBOUNDS)
    
    CLASS(FIELD_2LM_WRAPPER), INTENT(INOUT) :: SELF
  ...
  END SUBROUTINE FIELD_2LM_WRAP

  SUBROUTINE FIELD_2LM_OWNER_INIT (SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED)
  ...
  SUBROUTINE FIELD_2LM_ALLOCATE (SELF)
    
    CLASS(FIELD_2LM_OWNER) :: SELF

    
    
  END SUBROUTINE FIELD_2LM_ALLOCATE
  ...
  SUBROUTINE FIELD_2LM_DELETE_DEVICE(SELF)
    
    CLASS(FIELD_2LM) :: SELF

    
  END SUBROUTINE FIELD_2LM_DELETE_DEVICE
  ...
  SUBROUTINE FIELD_2LM_GET_HOST_DATA (SELF, MODE, PTR, QUEUE)
    CLASS(FIELD_2LM),                INTENT(INOUT) :: SELF
  ...
  SUBROUTINE FIELD_2LM_OWNER_GET_HOST_DATA (SELF, MODE, PTR, QUEUE)
    CLASS(FIELD_2LM_OWNER),          INTENT(INOUT) :: SELF
    INTEGER (KIND=JPIM),           INTENT(IN)    :: MODE
    LOGICAL(KIND=JPLM), POINTER,          INTENT(INOUT) :: PTR(:,:)
    INTEGER (KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
  ...
  INTEGER (KIND=JPIM) FUNCTION FIELD_2LM_GET_LAST_CONTIGUOUS_DIMENSION (PTR) RESULT (JDIM)
  LOGICAL(KIND=JPLM), POINTER :: PTR (:,:)
  INTEGER*8 :: ISTRIDE (2)
