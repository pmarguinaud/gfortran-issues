...
CONTAINS
  ...
  PROCEDURE :: DELETE_DEVICE => FIELD_4RD_DELETE_DEVICE
  ...
  PROCEDURE, PRIVATE :: CREATE_DEVICE_DATA => FIELD_4RD_CREATE_DEVICE_DATA
END TYPE FIELD_4RD
...
CONTAINS
  ...
  SUBROUTINE FIELD_4RD_WRAP(SELF, DATA, PERSISTENT, LBOUNDS)
    
    CLASS(FIELD_4RD_WRAPPER), INTENT(INOUT) :: SELF
  ...
  END SUBROUTINE FIELD_4RD_WRAP

  SUBROUTINE FIELD_4RD_OWNER_INIT (SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED)
  ...
  SUBROUTINE FIELD_4RD_DELETE_DEVICE(SELF)
    
    CLASS(FIELD_4RD) :: SELF

    
  END SUBROUTINE FIELD_4RD_DELETE_DEVICE
  ...
  SUBROUTINE FIELD_4RD_GET_HOST_DATA (SELF, MODE, PTR, QUEUE)
    CLASS(FIELD_4RD),                INTENT(INOUT) :: SELF
  ...
  SUBROUTINE FIELD_4RD_OWNER_GET_HOST_DATA (SELF, MODE, PTR, QUEUE)
    CLASS(FIELD_4RD_OWNER),          INTENT(INOUT) :: SELF
    INTEGER (KIND=JPIM),           INTENT(IN)    :: MODE
    REAL(KIND=JPRD), POINTER,          INTENT(INOUT) :: PTR(:,:,:,:)
    INTEGER (KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
